    ...
    <div className="min-h-screen bg-paper text-ink">
      <div className="relative mx-auto flex min-h-screen max-w-xl flex-col px-4 pb-12 pt-6 md:px-8 md:pt-8">
        ...
        <main className="mt-8">
          ...
          {diagnosis && (
            <p className="mt-3 rounded-xl border border-toss/30 bg-toss/5 px-3 py-2 text-[12px] text-ink">
              방금 진행한 자가진단 결과({diagnosis.totalScore}점 · {diagnosis.label})가 문의 내용에 함께 전달됩니다.
            </p>
          )}

          <fieldset className="mt-6">
            <legend className="text-xs font-semibold text-zinc-700">관심 영역 (복수 선택, 선택 사항)</legend>
