          ...
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
            ...
            <div className="flex flex-col gap-3 pt-4 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="inline-flex flex-1 items-center justify-center rounded-full bg-ink px-6 py-3 text-sm font-semibold text-white shadow-edge transition hover:bg-zinc-800 md:flex-none"
                >
                  다음 단계로 · 진단 시작
                </button>
              </div>
